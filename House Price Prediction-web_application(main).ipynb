{
 "cells": [
  ...
  },
  {
   ...
   "source": [
    "df1 = pd.read_csv(\"/Users/ayushsingh/Downloads/Bengaluru_House_Data.csv\")\n",
    "df1.head()"
   ]
  },
  {
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "# Data cleaning:Handel NA Values"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "/var/folders/_r/t9mjmwpn39nc9n_ksrqyyjn00000gn/T/ipykernel_57085/2716584372.py:1: SettingWithCopyWarning: \n",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "Before and after outlier removal: Rajaji Nagar , Hebbal\n"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      " 'Hormavu' 'Hosa Road' 'Hosakerehalli' 'Hoskote' 'Hosur Road' 'Hulimavu'\n",
      " 'ISRO Layout' 'ITPL' 'Iblur Village' 'Indira Nagar' 'JP Nagar' 'Jakkur'\n",
      ...
      " 'Kammanahalli' 'Kammasandra' 'Kanakapura' 'Kanakpura Road' 'Kannamangala'\n",
      " 'Karuna Nagar' 'Kasavanhalli' 'Kasturi Nagar' 'Kathriguppe'\n",
      " 'Kaval Byrasandra' 'Kenchenahalli' 'Kengeri' 'Kengeri Satellite Town'\n",
      " 'Kereguddadahalli' 'Kodichikkanahalli' 'Kodigehaali' 'Kodigehalli'\n",
      " 'Kodihalli' 'Kogilu' 'Konanakunte' 'Koramangala' 'Kothannur' 'Kothanur'\n",
      ...
      " 'Malleshpalya' 'Malleshwaram' 'Marathahalli' 'Margondanahalli' 'Marsur'\n",
      " 'Mico Layout' 'Munnekollal' 'Murugeshpalya' 'Mysore Road' 'NGR Layout'\n",
      ...
      " 'Raja Rajeshwari Nagar' 'Rajaji Nagar' 'Rajiv Nagar' 'Ramagondanahalli'\n",
      ...
      " 'Shivaji Nagar' 'Singasandra' 'Somasundara Palya' 'Sompura'\n",
      " 'Sonnenahalli' 'Subramanyapura' 'Sultan Palaya' 'TC Palaya'\n",
      " 'Talaghattapura' 'Thanisandra' 'Thigalarapalya' 'Thubarahalli' 'Tindlu'\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "pipe = LinearRegression(normalize=True)"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [],
   "source": [
    "pipe=make_pipeline(column_trans,scaler,pipe)"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "/Users/ayushsingh/opt/anaconda3/lib/python3.9/site-packages/sklearn/linear_model/_base.py:141: FutureWarning: 'normalize' was deprecated in version 1.0 and will be removed in 1.2.\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "pk.dump(lr_clf,open(filename,'wb'))"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    " model_columns = list(df2.columns)\n",
  ...
  },
  {
   ...
   "source": [
    "# import pickle\n",
    "# pickle.dump(pipe, open('LinearRegression1.pkl', 'wb'))"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "#                             [\n",
    "#                                 input(\"bath:\", type='number', name='bath'),\n",
    "#                                 input(\"total_sqft:\", type='number', name='total_sqft'),\n",
    "#                                 input(\"bhk:\", type='number', name='bhk')\n",
    "#                             ])\n",
    "# # Read location options from CSV file\n",
    "# locations = pd.read_csv(\"/Users/ayushsingh/Downloads/House-Price-Prediction-main/cleaned_data.csv\")['location'].unique().tolist()\n",
    "\n",
    "# # Dropdown Select for Text Feature 'location'\n",
    "# location = select('Select location:', options=locations)\n",
    "\n",
    "# # Combine Input Data\n",
    "# input_data = [\n",
    "#     [inputs_numeric['bath'],\n",
    "#      inputs_numeric['total_sqft'],\n",
    "#      inputs_numeric['bhk'],\n",
    "#      location]\n",
    "# ]\n",
    "# # Make Prediction\n",
    ...
    "\n",
    "# # Display Prediction\n",
    "# put_text(f'The estimated price of the house is Rs {prediction:,.2f}')\n",
    "\n",
    "\n"
   ]
  },
  {
   ...
   "source": [
    ...
    "#     st.header('Enter the details of the house you want to predict')\n",
    "    \n",
    "#     # Input for number of bathrooms\n",
    "#     bath = st.slider('Number of Bathrooms', 1, 10, 1)\n",
    "    \n",
    "#     # Input for square feet\n",
    "#     total_sqft = st.slider('Area (sqft)', 100, 10000, 100)\n",
    "    \n",
    "#     # Input for number of bedrooms\n",
    "#     bhk = st.slider('Number of Bedrooms', 1, 10, 1)\n",
    "    \n",
    "#     # Dropdown select for location\n",
    "#     location = st.selectbox('Location', locations)\n",
    "    \n",
    "#     # Make prediction\n",
    "#     input_data = [[bath, total_sqft, bhk, location]]\n",
    "#     prediction = model.predict(input_data)\n",
    "    \n",
    "#     # Display prediction\n",
    "#     st.subheader('Prediction')\n",
    "#     st.write(f'The estimated price of the house is Rs.{prediction[0]:,.2f}')\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "# # Input Group for Numeric Features\n",
    "# bath = st.number_input(\"Enter no. of bath:\", value=0)\n",
    "# total_sqft = st.number_input(\"Enter total sqft:\", value=0)\n",
    "# bhk = st.number_input(\"Enter no. of bhk:\", value=0)\n",
    "\n",
    "# # Read location options from CSV file\n",
    "# locations = pd.read_csv(\"/Users/ayushsingh/Downloads/House-Price-Prediction-main/cleaned_data.csv\")['location'].unique().tolist()\n",
    "\n",
    ...
    "#     # Combine Input Data\n",
    "#     input_data = [\n",
    "#         [bath, total_sqft, bhk, location]\n",
    "#     ]\n",
    "#     # Make Prediction\n",
    "#     prediction = model.predict(input_data)[1]\n",
    "#     # Display Prediction\n",
    "#     st.write(f'The estimated price of the house is Rs {prediction:,.2f}')\n"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    ...
    "#     # Make Prediction\n",
    "#     loop = get_event_loop()\n",
    "#     prediction = loop.run_until_complete(loop.run_in_executor(None, model.predict, input_data))[1]\n",
    "#     # Display Prediction\n",
    "#     st.write(f'The estimated price of the house is Rs {prediction:,.2f}')\n"
   ]
  },
  {
   ...
   "source": [
    ...
    "#     # Make Prediction\n",
    "#     loop = asyncio.get_event_loop()\n",
    "#     prediction = loop.run_until_complete(asyncio.run(model.predict(input_data)))[1]\n",
    "#     # Display Prediction\n",
    "#     st.write(f'The estimated price of the house is Rs {prediction:,.2f}')\n"
   ]
  },
  {
   ...
   "source": [
    ...
    "if np.isnan(inputs_numeric['bath']) or np.isnan(inputs_numeric['total_sqft']) or np.isnan(inputs_numeric['bhk']):\n",
    "    put_text(\"Please enter valid numeric values for all features.\")\n",
    "else:\n",
    "    # Combine Input Data\n",
    "    input_data = pd.DataFrame({'bath': [inputs_numeric['bath']],\n",
    "                              'total_sqft': [inputs_numeric['total_sqft']],\n",
    "                              'bhk': [inputs_numeric['bhk']],\n",
    "                              'location': [location]})\n",
    "    \n",
    "    # Make Prediction\n",
    ...
    "    \n",
    "    # Display Prediction\n",
    "    put_text(f'The estimated price of the house is  {prediction/100:,.2f} crores')"
   ]
  },
  {
   "cell_type": "code",
